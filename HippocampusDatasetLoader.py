...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # ANSWER: The label needs to be an integer for processing by the CNN/loss function. It will be much easier for the algorithm to operate with ground truths that are integers. 
